...
const en = {
  ...
  help_name: 'Help',
  help_desc: 'Getting started, how-tos and troubleshooting',
  help_open_docs: 'Open documentation',
...
const de: Record<keyof typeof en, string> = {
  ...
  help_name: 'Hilfe',
  help_desc: 'Erste Schritte, Anleitungen und Fehlersuche',
  help_open_docs: 'Dokumentation öffnen',
  help_report_issue: 'Problem melden',
  set_layout: 'Layout',
