...
const en = {
  ...
  set_mobileexport_desc: 'On iPhone/iPad: exports the letter as a one-tap vector PDF.',
...
const de: Record<keyof typeof en, string> = {
  ...
  set_mobileexport_desc: 'Auf iPhone/iPad: exportiert den Brief als Ein-Tipp-Vektor-PDF.',
