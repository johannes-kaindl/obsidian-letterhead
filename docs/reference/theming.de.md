...
> Hinweis: Das Token-Präfix `--bk-…` und die Klassen `.bk-…` sind historisch —
> `bk` = „Briefkopf", das deutsche Wort für den Briefkopf und der ursprüngliche
> Projektname.
...
Hintergrund: [DIN 5008](../explanation/din5008.de.md).
